...
namespace FSBS.Infrastructure.Persistence.Migrations.Migrations
{
    ...
    [Migration("20260502190538_InitialCreate")]
            ...
            modelBuilder.Entity("FSBS.Domain.Entities.Booking", b =>
                {
                    ...
                    b.ToTable("bookings", "fsbs", t =>
                        {
                            t.HasCheckConstraint("ck_bookings_cc_capacity", "training_type != 'CabinCrew' OR student_count <= 10");

                            t.HasCheckConstraint("ck_bookings_discount_pct", "discount_gbp IS NULL OR (discount_gbp >= 0 AND discount_gbp <= gross_price_gbp)");

                            t.HasCheckConstraint("ck_bookings_fd_capacity", "training_type != 'FlightDeck' OR student_count <= 4");
            ...
            modelBuilder.Entity("FSBS.Domain.Entities.Instructor", b =>
                {
                    ...
                    b.PrimitiveCollection<int[]>("TrainingTypeRatings")
                        .IsRequired()
                        .HasColumnType("training_type[]")
            ...
            modelBuilder.Entity("FSBS.Domain.Entities.SimulatorConfiguration", b =>
                {
                    ...
                    b.PrimitiveCollection<int[]>("SupportedTrainingTypes")
                        .IsRequired()
                        .HasColumnType("training_type[]")
